...
export const REPORT_PARAMETER_CATALOG: CatalogItem[] = [
  ...
  { secao: 'perfil', campo: 'explicacao_socioestilo', titulo: 'O que é Sócio Estilo', descricao: 'Explicação introdutória da metodologia para o participante.', ordem: 40 },
  { secao: 'perfil', campo: 'quatro_socioestilos', titulo: 'Conheça os Quatro Sócio Estilos', descricao: 'Tabela comparativa dos quatro sócio estilos.', ordem: 50 },
  ...
  { secao: 'perfil', campo: 'potencializacao_talentos', titulo: 'Como Potencializar seus Talentos', descricao: 'Talento identificado, valor gerado, contextos, estratégias e ponto de equilíbrio.', ordem: 100 },
  ...
  { secao: 'metodologia', campo: 'metodologia_potenciar', titulo: 'Sobre a Metodologia', descricao: 'Texto breve de encerramento para o relatório do participante.', ordem: 240 },
